  ...
  return (
    <div className="w-full">
      <div className="bg-white rounded-md px-4 py-2 shadow-md max-w-80 mx-auto">
        <div>
          <h2 className="text-center text-2xl font-semibold py-6">Signin</h2>
        </div>
        ...
        <form>
          ...
          <div className="flex flex-row flex-nowrap justify-between items-center py-4">
            <label className="flex flex-row flex-nowrap items-center">
              ...
              <span className="text-sm ml-2">Keep me logged in</span>
            </label>
            <Link
              className="text-sm text-slate-300 hover:text-slate-500"
              to="/recover"
            >
              Forgot Password?
            </Link>
          ...
          <button
            className="w-full text-center bg-slate-300 hover:bg-slate-500 rounded-md py-1"
            type="submit"
          >
            Signin
          </button>
